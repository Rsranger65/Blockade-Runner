...
public class Font {
	...
	public Font(PApplet context, String filename) {
		this(context, context.loadImage(filename));
	}

	public Font(PApplet context, PImage img) {
		this.sheet = new SpriteSheet(context, img, 16, 8);
	}
